...
public class StatisticsMain3 {
    ...
    public  static void thirdPart(String nameFile){
        ...
        TicTacToe2AI ticaTacToe = new TicTacToe2AI(config0);
        ticaTacToe.start();
        ...
        ticaTacToe = new TicTacToe2AI(config1);
        ticaTacToe.start();
        ...
        ticaTacToe = new TicTacToe2AI(config2);
        ticaTacToe.start();
        ...
        ticaTacToe = new TicTacToe2AI(config3);
        ticaTacToe.start();
