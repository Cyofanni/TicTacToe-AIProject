...
public class StatisticsMain2 {
    ...
    public  static void secondPart(String nameFile, int nRip){
        AbsConfig config0 = new Config(0,5,0,0,0,4,0,0,1);
        AbsConfig config1 = new Config(0,5,0,1,0,4,0,0,1);
        AbsConfig config2 = new Config(0,5,0,2,0,4,0,0,1);
        AbsConfig config3 = new Config(0,5,0,3,0,4,0,0,1);
